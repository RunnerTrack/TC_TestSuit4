...
function fn_createtestcaseduration()
{
	...
	tempCode = tempCode +  fn_htmlendrow() + fn_htmlclosetable() + fn_fontend();
	tempCode = tempCode + fn_htmlnewline()  + fn_htmlnewline() + fn_fontstart() + fn_htmlstarttable(1) + fn_htmlcreateheaders("S.No|Expected Result|Actual Result|Status|Test Data|Picture ") ;
...
//Returns  Test Step
function fn_createteststep(strStatus,strExpected,strActual,strTestData,wantScreenShot)
{
...
//	tempCode = fn_htmlstartrow() + fn_htmlrowdata(S_NO,"Center","White") ;
  var htmlstrrw0="<tr>\n";
//  var htmlstrrw=fn_htmlstartrow2();
	tempCode = htmlstrrw0;
	tempCode = tempCode + fn_htmlrowdata(S_NO,"Center","White") ;
...
//	#F5DEB3,#F5F5DC
	...
	//kg htmlreport = htmlreport + fn_fontcolor("White") + "<b>" + fn_htmlrowdata( tempOverAllStatus,"Center",tempOverAllstatusColor)  + "</b>" + fn_fontcolor("Black") ;
...
function fn_htmlrowdata(strHTMLRowData,stralign,bgcolor)
{
	...
	tempCode2 = "<td bgcolor = " + chr(34) + bgcolor + chr(34) + "align = " + chr(34) + stralign + chr(34) + ">" + strHTMLRowData + "</td>";
	return tempCode2 + Chr(10);
}
